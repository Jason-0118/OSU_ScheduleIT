...
if (isset($_POST['submit'])) {
    ...
    if (empty($topicErr) && empty($locationErr)) {
    ...
    <form method="POST" action="index.php" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 space-y-10 w-[65%]">
        ...
        <div class="flex flex-col items-center space-y-3">
            ...
            <?php if (!empty($topicErr)) : ?>
                <p class="text-red-600 text-xl bg-black/70 p-2">Title is required!</p>
            <?php endif; ?>
        </div>
        <!-- location -->
        <div class="flex flex-col items-center space-y-3">
            ...
            <?php if (!empty($locationErr)) : ?>
                <p class="text-red-600 text-xl bg-black/70 p-2">Location is required!</p>
            <?php endif; ?>
        </div>
